...
typedef void(__cdecl *pa_proplist_sets)(pa_proplist *p, const char *key,
                                        const char *value);
typedef void(__cdecl *pa_proplist_setp)(pa_proplist *p, const char *pair);
typedef void(__cdecl *pa_proplist_set)(pa_proplist *p, const char *key,
...
typedef void(__cdecl *pa_threaded_mainloop_signal)(pa_threaded_mainloop *m,
                                                   int wait_for_accept);
...
typedef pa_mainloop_api *(__cdecl *pa_threaded_mainloop_get_api)(
...
typedef void(__cdecl *pa_context_success_cb_t)(pa_context *c, int success,
                                               void *userdata);
typedef void(__cdecl *pa_context_event_cb_t)(pa_context *c, const char *name,
...
typedef void(__cdecl *pa_context_set_state_callback)(pa_context *c,
                                                     pa_context_notify_cb_t cb,
                                                     void *userdata);
typedef void(__cdecl *pa_context_set_event_callback)(pa_context *p,
...
typedef int(__cdecl *pa_context_connect)(pa_context *c, const char *server,
                                         pa_context_flags_t flags,
                                         const pa_spawn_api *api);
typedef void(__cdecl *pa_context_disconnect)(pa_context *c);
typedef pa_operation *(__cdecl *pa_context_drain)(pa_context *c,
                                                  pa_context_notify_cb_t cb,
                                                  void *userdata);
typedef void (*pa_stream_success_cb_t)(pa_stream *s, int success,
                                       void *userdata);
typedef void (*pa_stream_request_cb_t)(pa_stream *p, size_t nbytes,
                                       void *userdata);
typedef void (*pa_stream_notify_cb_t)(pa_stream *p, void *userdata);
typedef pa_stream *(__cdecl *pa_stream_new)(pa_context *c, const char *name,
...
typedef int(__cdecl *pa_stream_connect_playback)(pa_stream *s, const char *dev,
                                                 const pa_buffer_attr *attr,
                                                 pa_stream_flags_t flags,
                                                 const pa_cvolume *volume,
                                                 pa_stream *sync_stream);
typedef int(__cdecl *pa_stream_disconnect)(pa_stream *s);
typedef int(__cdecl *pa_stream_cancel_write)(pa_stream *p);
typedef int(__cdecl *pa_stream_write)(pa_stream *p, const void *data,
...
typedef const pa_buffer_attr *(__cdecl *pa_stream_get_buffer_attr)(
    pa_stream *s);
typedef pa_operation *(__cdecl *pa_stream_drain)(pa_stream *s,
                                                 pa_stream_success_cb_t cb,
                                                 void *userdata);
typedef void(__cdecl *pa_stream_set_state_callback)(pa_stream *s,
                                                    pa_stream_notify_cb_t cb,
                                                    void *userdata);
typedef void(__cdecl *pa_stream_set_write_callback)(pa_stream *p,
                                                    pa_stream_request_cb_t cb,
                                                    void *userdata);
typedef void(__cdecl *pa_stream_set_underflow_callback)(
    pa_stream *p, pa_stream_notify_cb_t cb, void *userdata);
typedef void(__cdecl *pa_stream_set_started_callback)(pa_stream *p,
                                                      pa_stream_notify_cb_t cb,
                                                      void *userdata);
typedef pa_operation *(__cdecl *pa_stream_cork)(pa_stream *s, int b,
                                                pa_stream_success_cb_t cb,
                                                void *userdata);
typedef int(__cdecl *pa_stream_is_corked)(pa_stream *s);
typedef pa_operation *(__cdecl *pa_stream_flush)(pa_stream *s,
                                                 pa_stream_success_cb_t cb,
                                                 void *userdata);
typedef int(__cdecl *pa_stream_get_latency)(pa_stream *s, pa_usec_t *r_usec,
                                            int *negative);
typedef pa_operation *(__cdecl *pa_stream_update_timing_info)(
    pa_stream *p, pa_stream_success_cb_t cb, void *userdata);
typedef const pa_timing_info *(__cdecl *pa_stream_get_timing_info)(
    pa_stream *s);
typedef const pa_sample_spec *(__cdecl *pa_stream_get_sample_spec)(
    pa_stream *s);
typedef pa_operation *(__cdecl *pa_stream_trigger)(pa_stream *p,
                                                   pa_stream_success_cb_t cb,
                                                   void *userdata);
typedef pa_operation *(__cdecl *pa_stream_update_sample_rate)(
    pa_stream *s, uint32_t rate, pa_stream_success_cb_t cb, void *userdata);
typedef pa_usec_t(__cdecl *pa_bytes_to_usec)(uint64_t length,
                                             const pa_sample_spec *spec);
typedef size_t(__cdecl *pa_usec_to_bytes)(pa_usec_t t,
                                          const pa_sample_spec *spec);
...
typedef pa_channel_map *(__cdecl *pa_channel_map_init_auto)(
...
typedef pa_operation *(__cdecl *pa_context_set_sink_input_volume)(
...
typedef pa_cvolume *(__cdecl *pa_cvolume_set)(pa_cvolume *a, unsigned channels,
                                              pa_volume_t v);
typedef void(__cdecl *pa_context_set_event_callback)(pa_context *p,
                                                     pa_context_event_cb_t cb,
                                                     void *userdata);
...
typedef int(__cdecl *pa_cvolume_equal)(const pa_cvolume *a,
                                       const pa_cvolume *b);
...
typedef void (*pa_sink_input_info_cb_t)(pa_context *c,
                                        ...
                                        void *userdata);
typedef pa_operation *(__cdecl *pa_context_get_sink_input_info)(
...
typedef pa_operation *(__cdecl *pa_context_subscribe)(
    pa_context *c, pa_subscription_mask_t m, pa_context_success_cb_t cb,
    void *userdata);
typedef void(__cdecl *pa_context_set_subscribe_callback)(
